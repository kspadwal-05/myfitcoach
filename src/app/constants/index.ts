export const USER_PROGRAMS = [
  {
    ...
    workout_plan: {
      ...
      description:
        "This program focuses on building a consistent habit of exercise with joint-friendly movements that protect your lower back. The mix of cardio and strength training supports weight loss while preserving muscle mass.",
    },
    diet_plan: {
