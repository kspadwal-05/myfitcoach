        ...
        <div className="space-y-8">
          ...
          <div className="relative backdrop-blur-sm border border-border p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {allPlans.map((plan: { _id: string | number | bigint | ((prevState: string | null) => string | null) | null | undefined; name: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; isActive: any; }) => (
                <Button
                  key={plan._id}
                ...
                <TabsContent value="workout">
                  <div className="space-y-4">
                    ...
                    <Accordion type="multiple" className="space-y-4">
                      {currentPlan.workoutPlan.exercises.map((exerciseDay: { day: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; routines: any[]; }, index: Key | null | undefined) => (
                        <AccordionItem
                          key={index}
